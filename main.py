...
flags.DEFINE_integer("train_batch_size", 4, "The size of batch images [64]")
...
flags.DEFINE_integer("lambdl1", 5, "l1 norm lambda hyperparameter")
flags.DEFINE_integer("save_freq", 1, "Freq to save")    # save_freq
flags.DEFINE_integer("histlen", 2, "History seq length")
flags.DEFINE_integer("futulen", 1, "Future seq length")
flags.DEFINE_float("learn_rate", 5e-8, "learn_rate")  # lyq 5e-4 -> 5e-3,integer->float
FLAGS = flags.FLAGS
